...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTSIMULATOR = 2;

  private static final SparseIntArray INTERNAL_LAYOUT_ID_LOOKUP = new SparseIntArray(2);

  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.flightmobileapp.R.layout.fragment_login, LAYOUT_FRAGMENTLOGIN);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.flightmobileapp.R.layout.fragment_simulator, LAYOUT_FRAGMENTSIMULATOR);
  }
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_FRAGMENTSIMULATOR: {
          ...
          throw new IllegalArgumentException("The tag for fragment_simulator is invalid. Received: " + tag);
        }
      }
    }
    return null;
